 ...
 */
define(['text!data/sampleData.json', "ojs/ojarraytreedataprovider", "ojs/ojflattenedtreedataproviderview",  "ojs/ojhtmlutils", "text!views/rowTemplateText.html",'../accUtils', 'knockout', "ojs/ojconverter-datetime", "ojs/ojasyncvalidator-regexp", "ojs/ojarraydataprovider", "ojs/ojconverterutils-i18n", "ojs/ojbutton", "ojs/ojradioset", "ojs/ojdatetimepicker", "ojs/ojselectsingle",'ojs/ojvalidationgroup', 'ojs/ojformlayout', 'ojs/ojinputtext', "ojs/ojswitch", "ojs/ojnavigationlist",  "ojs/ojtable", "ojs/ojchart", "ojs/ojrowexpander"],
 function(sampleData, ArrayTreeDataProvider, FlattenedTreeDataProviderView, HtmlUtils, rowTemplateText, accUtils, ko, ojconverter_datetime_1, AsyncRegExpValidator, ArrayDataProvider, ojconverterutils_i18n_1) {
    function logViewerViewModel() {
      ...
      this.arrayTreeDataProvider = new ArrayTreeDataProvider(JSON.parse(sampleData), {
