 ...
 function(
  ...
  ojconverterutils_i18n_1
    ...
    function logViewerViewModel() {
      ...
      // tabData should control the data parsed giving the filtering effect
      this.tableData = JSON.parse(logData).results;
      ...
      this.arrayTreeDataProvider = new ArrayTreeDataProvider(this.tableData, {
