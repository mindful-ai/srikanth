  ...
  function(ko, Context, moduleUtils, KnockoutTemplateUtils, CoreRouter, ModuleRouterAdapter, KnockoutRouterAdapter, UrlParamAdapter, ResponsiveUtils, ResponsiveKnockoutUtils, ArrayDataProvider) {
     ...
     function ControllerViewModel() {
      ...
      let navData = [
        ...
        { path: 'logviewer', detail: { label: 'Log Viewer', iconClass: 'oj-ux-ico-bar-chart' } },
        { path: 'incidents', detail: { label: 'Tab B', iconClass: 'oj-ux-ico-fire' } },
        { path: 'customers', detail: { label: 'Tab C', iconClass: 'oj-ux-ico-contact-group' } },
      ...
      this.appName = ko.observable("FA POD Log Viewer");
      // User Info used in Global Navigation area
      this.userLogin = ko.observable("shrikanth@oracle.com");
